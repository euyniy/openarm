...
To get started, follow this [guide](install) guide to install ROS2 first to setup and test the [OpenArm description](../description) package which you will need for ROS2 control.
